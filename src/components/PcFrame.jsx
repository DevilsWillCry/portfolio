  ...
  return (
    <>
      ...
      <div className="before:w-[90%] before:h-[90%] before:fixed before:border-solid before:border-t-[5px]  before:border-b-[5px] before:rounded-t-xl before:border-gray-400 before:top-0 before:z-[60] before:left-[50%] before:translate-x-[-50%] before:pointer-events-none">
        ...
        <div className={`w-[90%] h-[90%] fixed border-solid border-[35px]  border-[#222222] rounded-t-xl  z-50 top-0 left-[50%] translate-x-[-50%] pointer-events-none overflow-hidden shadow-[0_0_3px_0_white]  transition-all  duration-1000 ${isOn ? "bg-none animate-tv-flicker" : "bg-black"}`}></div>
